"""
Production settings for StudyCon project.
Use this for deployment to pin-it.net
"""
...
# Redis for WebSocket channels (production)
CHANNEL_LAYERS = {
    "default": {
...
# Push Notifications Settings for production
PUSH_NOTIFICATIONS_SETTINGS = {
    "APNS_CERTIFICATE": os.environ.get('APNS_CERTIFICATE_PATH', '/path/to/production/certificate.pem'),
    "APNS_TOPIC": "com.pinit.app",  # Your actual app bundle ID
